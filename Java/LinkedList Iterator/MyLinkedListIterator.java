...
public class MyLinkedList<E> extends AbstractList<E> {
    ...
    /**
     * Creates and returns a list iterator
     * 
     * @return the iterator
     */
    ...
    /**
     * This class is the iterator for the linked List class
     * with these variables: left, right, idx, forward, &
     * canRemoveOrSet.
     */
    protected class MyListIterator implements ListIterator<E> {
        ...
        Node left, right;
        int idx;
        boolean forward, canRemoveOrSet;

        // MyListIterator methods
        /**
         * Default constructor for the MyListIterator class.
         */
        ...
        /**
         * this method checks if there is a next element in the list
         * 
         * @return if theres is a next element
         */
        ...
        /**
         * This method returns the next element and moves 
         * the iterator forward one node
         * 
         ...
         * 
         * @return if theres is a previous element
         */
        ...
        /**
         * This method returns the previous element and moves 
         * the iterator back one node
         * 
         ...
         * If at the last element it returns the size.
         * 
        ...
        /**
         * /**
         * This method returns the index of the previous node.
         * If at the first element it returns -1.
         * 
        ...
        /**
         * This method adds a new element before the element of the last
         * previous/next call.
         * 
         */
        ...
        /**
         * this method sets the last node returned by the 
         * previous/next call with a new element.
         * 
        ...
        /**
         * This method removes the last node returned by 
         * the revious/next call.
         */
        public void remove(){
            if(!canRemoveOrSet){
                throw new IllegalStateException();
